...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            // Verificar que el bot esté en el servidor origen
            ...
            // Obtener canales del servidor origen
            ...
            // Crear resumen de lo que se copiará
            ...
            // Si es solo vista previa, mostrar el resumen y salir
            if (soloVista) {
                return await interaction.editReply({
            ...
            for (const canal of canalesTextoOrigen.values()) {
                try {
                    ...
                    // Asignar categoría si existe y se está incluyendo
